...
;
	...
	$PROVIDERS_CONFIG      = ARRAY(
								...
								ARRAY( 
									...
									"require_client_id" => TRUE, 
									"callback"          => TRUE,
									"new_app_link"      => "http://dev.t.qq.com/development",
									"userguide_section" => "http://hybridauth.sourceforge.net/userguide/IDProvider_info_QQ.html",
								)
								,
								ARRAY( 
									"label"             => "Sina",
									...
									"require_client_id" => TRUE, 
									"callback"          => TRUE,
									"new_app_link"      => "http://open.weibo.com/apps/new?sort=web",
									"userguide_section" => "http://hybridauth.sourceforge.net/userguide/IDProvider_info_Sina.html",
								),
							);
