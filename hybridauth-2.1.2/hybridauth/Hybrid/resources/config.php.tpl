...
return 
	array(
		...
		"providers" => array ( 
			...
			"QQ" => array ( 
				"enabled" => #QQ_ADAPTER_STATUS#,
				"keys"    => array ( "id" => "#QQ_APPLICATION_APP_ID#", "secret" => "#QQ_APPLICATION_SECRET#" ) 
			),

			"Sina" => array (
				"enabled" => #SINA_ADAPTER_STATUS#,
				"keys"    => array ( "id" => "#SINA_APPLICATION_APP_ID#", "secret" => "#SINA_APPLICATION_SECRET#" ) 
			),
		),
