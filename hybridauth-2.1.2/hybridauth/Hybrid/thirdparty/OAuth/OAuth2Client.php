...
class OAuth2Client
{
	...
	public function authenticate( $code )
	{
        ...
        Hybrid_Logger::info( "++++Enter OAuth2Client::request(openid)++" .$response->openid);
		Hybrid_Logger::info( "++++Enter OAuth2Client::request(access_token)++" .$response->access_token);
		...
		$_SESSION["PROVIDER::ID"] = $this->client_id;
		$_SESSION["QQ::OPENID"]   = $response->openid; 
